...
import (
	...
	"github.com/cybertmt/OTUS-GO/hw12_13_14_15_calendar/internal/clock"
	...
	"github.com/cybertmt/OTUS-GO/hw12_13_14_15_calendar/internal/storage/production"
)
...
func main() {
	...
	config, err := internalconfig.LoadSchedulerConfig(configFile)
	if err != nil {
